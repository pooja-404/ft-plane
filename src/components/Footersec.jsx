        ...
        <div className=' pt-5 '>
            <div className="max-w-[1140px] px-3 mx-auto  ">
                ...
                <div className='flex justify-center items-center gap-1 pt-8 pb-5'>
                    ...
                    <p className='text-white font-Montserrat font-normal sm:text-sm text-[13px]'>FT PLANE 2022 All right reserved</p>
                </div>
...
export default Footer
    ...
    //         <div className='flex flex-wrap flex-row pt-5 pb-8'>
    ...
    //                 <div className='flex gap-3 pt-4'>
    //                     <div>
    //                         <div className='w-9 h-9  rounded-[36px] bg-[#fff] flex items-center justify-center'>
    //                             <svg width="10" height="17" viewBox="0 0 10 17" fill="none" xmlns="http://www.w3.org/2000/svg">
    //                                 <path d="M6.33184 16.0709V8.15025H8.72115L9.03786 5.36255H6.33184L6.33586 3.96718C6.33586 3.24008 6.40976 2.85068 7.52724 2.85068H9.02111V0.0625H6.63126C3.76063 0.0625 2.7504 1.41477 2.7504 3.6892V5.36277H0.960938V8.15072H2.7504V15.9586C3.44753 16.0884 4.16824 16.157 4.90618 16.157C5.38288 16.157 5.85909 16.1283 6.33184 16.0709Z" fill="#17181C" />
    //                             </svg>
    //                         </div>
    ...
    //                 </div>
    //             </div>
    //             <div className='md:w-7/12 w-full px-lg-3 pt-5 pt-lg-0'>
    //                 <div className='flex flex-wrap flex-row'>
    //                     <div className='xl:w-5/12 sm:w-4/12 w-1/2 px-3'>
    //                         <h2 className='text-white font-Monstserrat font-bold text-2xl'>Address</h2>
    //                         <ul>
    //                             <li className='pt-1'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Integrations</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Hello</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Intercom</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Customer</a></li>
    //                         </ul>
    ...
    //                         <ul>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat '>Our Blog</a></li>
    //                             <li className='pt-1'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Customers</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Our Team</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Careers</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Integrations</a></li>
    //                         </ul>
    ...
    //                         <ul>
    //                             <li className='pt-1'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Test Zoom</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Account</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat text-nowrap	'>Support Center</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Live Training</a></li>
    //                             <li className='pt-2'><a href="" className='text-[#A7A7A7] text-base font-normal font-Monstserrat'>Accessibility</a></li>
    //                         </ul>
    //                     </div>
    //                 </div>
    //             </div>
